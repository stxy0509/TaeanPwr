...
#define SPI_BASE_ADDR	0xA0021000
#define R_SPI0CON(N)      ((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+0))
...
#define	R_SPI0BAUD(N)	((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+4))

#define R_SPI0STAT(N)	((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+8))
...
#define R_SPI0DATA(N)     ((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+0xc))

#define R_SSX0CON(N)      ((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+0x10))
#define SSXCR_SSXCON    (1 << 0)

#define R_SPI0INT(N)	    ((volatile unsigned int*)(SPI_BASE_ADDR+(N*0x400)+0x14))
